...
/**
@typedef {import('jrjs-shared/packages/lib/sys/run.js').PrimaryConfig} PrimaryConfig;
*/

import { globalState, hydrate, log } from 'jrjs-shared/packages/lib/sys/sys.js';
...
hydrate(globalState.primaryConfig, params, config);
